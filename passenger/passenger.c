...
int addPassenger(flight *f ){
    ...
    add_bag(passenger1);
    //add_handbag(passenger1);

    if(f->visa == 1) {
        printf("Le passager possede-t-il son visa (1=OUI, 0=NON)? \n");
        scanf("%d", &passenger1->visa);
    }
...
//SI IL Y A MOINS DE PASSAGER ENREGISTREs QUE DE PRIORITAIRE
